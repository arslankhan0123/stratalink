...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).MetisMenu =
        e());
})(this, function () {
  "use strict";
  const t = {
  ...
  class s {
    ...
    show(t) {
      ...
      const d =
        null == h ? void 0 : h.querySelector(this.config.triggerElement);
      ...
      const g = [].slice
        .call(
          null === (s = null == h ? void 0 : h.parentNode) || void 0 === s
            ? void 0
            : s.children
        )
        .filter((t) => t !== h);
    ...
    hide(t) {
      ...
      (r.style.height = `${r.getBoundingClientRect().height}px`),
        ...
        (r.style.height = "0px");
      const h =
        null == c ? void 0 : c.querySelector(this.config.triggerElement);
