    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between d-flex align-items-center">
                <h4 class="card-title shine">Managers Create</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('managers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="type" required>
                                        ...
                                        <option value="Building Manager" {{ $type == 'Building Manager' ? 'selected' : '' }}>Building Manager</option>
                                        <option value="Strata Manager" {{ $type == 'Strata Manager' ? 'selected' : '' }}>Strata Manager</option>
                                    </select>

                                </div>
                            </div>
                            <input type="hidden" value="{{$type}}" name="buildingType" id="formrow-name-input">
                            <input type="hidden" value="{{$buildingId}}" name="buildingId" id="formrow-name-input">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="formrow-number-input">Phone Number</label>
                                    <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                        name="phone_number" id="formrow-phone_number-input" required>
                                    @error('phone_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
