    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between d-flex align-items-center">
                <h4 class="card-title shine">Managers Table</h4>
                @if (Auth::check() && in_array(Auth::user()?->role()?->first()?->name, ['admin', 'staff']))
                <a href="{{route('managers.create')}}" class="btn btn-sm btn-info">Create <i class="mdi mdi-arrow-right align-middle"></i></a>
                @endif
            </div>
            <div class="card-body">
                <!-- Table -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Job Actions">
                                    ...
                                    <a class="text-decoration-none me-2 text-dark ml-1" fdprocessedid="568bh6" href="{{route('managers.edit', ['id' => $manager->id])}}" data-bs-toggle="tooltip" title="Edit">
                                    ...
                                    <a href="{{route('managers.delete', ['id' => $manager->id])}}" class="bin-button ml-1" fdprocessedid="jtrex" data-bs-toggle="tooltip" title="Delete">
