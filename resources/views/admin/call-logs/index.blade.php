...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="bulk-action-form" method="POST" action="{{ route('call-logs.bulk-delete') }}">
                    @csrf
                    @method('DELETE')
                        ...
                        <table id="custom-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
                                            <input type="checkbox" class="checkbox-item" name="ids[]" value="{{ $call_log->id }}" id="checkbox{{ $call_log->id }}">
                                            <label for="checkbox{{ $call_log->id }}"></label>
                                        </span>
                                    </td>
                                    <td>{{ $call_log->id }}</td>
                                    <td>{{ \Carbon\Carbon::parse($call_log->created_at)->format('d M Y H:i') }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Job Actions">
                                            <a class="text-decoration-none me-2 text-dark ml-1" fdprocessedid="568bh6"
                                                ...
                                                <button class="editBtn" type="button" fdprocessedid="568bh6">
                    ...
                    <button type="submit" class="btn btn-danger mt-2" onclick="return confirm('Are you sure you want to delete selected call logs?')">
                        Delete Selected
                    </button>
                </form>
