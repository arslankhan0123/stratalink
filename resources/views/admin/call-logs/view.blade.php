...
@section('breadcrumbTitle', 'View Call Log')
...
<li class="breadcrumb-item active">View Call Log</li>
@endsection
@section('content')
<div class="row">
    <div class="col-xl-12">
        <div class="card card-h-100">
            <div class="card-header justify-content-between d-flex align-items-center">
                <h4 class="card-title shine">Call Log View</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ $call_log->name }}" id="formrow-name-input" required disabled>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ $call_log->email ?? '' }}" id="formrow-email-input" disabled required>
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="category" id="categorySelect" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select mb-3" name="building_id"
                                    ...
                                    id="buildingSelect" required disabled>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="hidden" id="selectedContractorId"
                                    value="{{ $call_log->contractor_id }}" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('number') is-invalid @enderror"
                                    name="number" value="{{ $call_log->number }}" disabled id="formrow-mobile-input" required>
                                @error('number')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('call_date') is-invalid @enderror"
                                    name="call_date" value="{{ $call_log->call_date }}" disabled id="formrow-mobile-input" required>
                                @error('call_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control @error('call_time') is-invalid @enderror"
                                    name="call_time" value="{{ $call_log->call_time }}" disabled id="formrow-mobile-input" required>
                                @error('call_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('total_time_spent_on_call') is-invalid @enderror"
                                    name="total_time_spent_on_call" value="{{ $call_log->total_time_spent_on_call }}" id="formrow-mobile-input" value="{{ \Carbon\Carbon::now('Australia/Sydney')->format('H:i') }}" disabled required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="audio_attachment" disabled id="audio_attachment" class="form-control">
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select mb-3" name="status"
                                    ...
                                    id="statusSelect" disabled required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="summary" disabled id="summary" class="form-control" rows="4" placeholder="Enter summary or description">{{ $call_log->summary}}</textarea>
                            </div>
                        </div>
