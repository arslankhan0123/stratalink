                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3" name="building_id"
                                        ...
                                        <option value="{{ $building->id }}"
                                            ...
                                            {{ $building->name }} (Address: {{ $building->address }})
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('building_id')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $building->building_notes }}" id="building_notes" class="form-control @error('building_notes') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="building_address" class="form-control @error('building_address') is-invalid @enderror"
                                            name="building_address" value="{{ $building->address }}" disabled readonly id="formrow-mobile-input" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="contractor_notes" id="contractor_notes" class="form-control" rows="4" placeholder="Enter notes or description">{{ $call_log->contractor_notes}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="send_sms_contractor">
                                    ...
                                    @if ($call_log->send_sms_contractor)
                                    <span style="color: green;">(Already Sent)</span>
                                    @endif
                                </label>
                            </div>
