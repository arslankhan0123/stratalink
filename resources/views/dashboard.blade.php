    ...
    <div class="d-flex justify-content-end">
        <select class="form-select mb-3" aria-label="Default select example" id="buildingSelect">
            ...
            <option value="{{ $building->id }}"
                {{ request()->query('building_id') == $building->id ? 'selected' : '' }}>{{ $building->name }}
            </option>
            @endforeach
        </select>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h6 class="font-size-xs text-uppercase">Total Calls</h6>
                        <h4 class="mt-4 mb-2 d-flex align-items-center">
                            {{ $data['total_call_logs_count'] }}
                        </h4>
    ...
    <div class="col-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h6 class="font-size-xs text-uppercase">Today's Calls</h6>
                        <h4 class="mt-4 mb-2 d-flex align-items-center">
                            {{ $data['today_call_log_count'] }}
                        </h4>
                        ...
                        <div class="col-sm-7">
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <h5>$12,582<small class="badge badge-success-subtle font-13 ms-2">+15%</small>
                                    </h5>
                                </div>
                            ...
                            <div class="mt-4">
                                <a href="" class="btn btn-secondary-subtle btn-sm">Generate
                                    Reports <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div> <!-- end col-->
                        <div class="col-sm-5">
                            <div class="mt-4 mt-0">
    ...
    <div class="col-12">
        <div class="card card-h-100">
            <div class="card-body">
                ...
                <h4 class="card-title mb-4">Buildings</h4>
                        ...
                        <ul class="list-inline main-chart mb-0 text-center">
                            <li class="list-inline-item chart-border-left me-0 border-0">
                                <h3 class="text-primary">$<span data-plugin="counterup">3.85k</span><span
                                        class="text-muted d-inline-block fw-normal font-size-15 ms-2">Name</span>
                                </h3>
                            </li>
                            <li class="list-inline-item chart-border-left me-0">
                                <h3><span data-plugin="counterup">258</span><span
                                        class="text-muted d-inline-block fw-normal font-size-15 ms-2">Call</span>
                                </h3>
                            </li>
                            <li class="list-inline-item chart-border-left me-0">
            ...
            <div class="card card-h-100">
                <div class="card-body">
                    ...
                    <div class="pt-3 pb-2">
                        ...
                        <p class="mt-4 mb-0 fw-medium">Australia <span class="float-end">85%</span>
                        </p>
                        <div class="progress animated-progess custom-progress mt-2">
...
<script>
    document.getElementById('buildingSelect').addEventListener('change', function() {
        ...
        if (buildingId) {
            window.location.href = "{{ route('dashboard') }}?building_id=" + buildingId;
        }
    });
</script>
<script>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        for (var i = 0; i < chartData.names.length; i++) {
            dataArray.push([chartData.names[i], chartData.callLogs[i]]);
        }
        ...
        var options = {
            chart: {
                title: 'Building Call Logs',
                subtitle: 'Number of Call Logs per Building',
            }
        };
...
{{-- <script src="{{ asset('tmp/js/dashboard-sales.init.js') }}"></script> --}}
